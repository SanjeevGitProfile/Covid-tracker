package git.sanjeev.covidtracker.services;
...
public class covidDataService {
    ...
    public void fetchCovidData() throws IOException, InterruptedException {
        ...
        for (CSVRecord record : records) {
            ...
            Integer previousCases = Integer.parseInt(record.get(record.size()-2));
            locationStats.setTotalCases(todayCases);
            locationStats.setDiffFromPreviousDay(todayCases - previousCases);
